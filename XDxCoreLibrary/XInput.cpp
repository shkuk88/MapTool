...
XBASIS_INPUT_MAP g_InputData;

bool   XInput::InitDirectInput()
{
	HRESULT hr = S_OK;
...
//   or     and      xor           xand          not
//   |       &       ^             없음          !   => 비트연산자
BYTE XInput::KeyCheck(BYTE dwKey)
{
	// GetKeyState()		// 동기적
...
bool XInput::Frame()
{
	...
	ZeroMemory(&g_InputData, sizeof(XBASIS_INPUT_MAP));
...
//}
//
//DWORD XInput::KeyCheck(DWORD key)
//{
//	DWORD sKey = GetAsyncKeyState(key);
//	if (sKey & 0x8000)
//	{
//		if (m_dwKeyState[key] == KEY_FREE || m_dwKeyState[key] == KEY_UP)
//		{
...
//	else
//	{
//		if (m_dwKeyState[key] == KEY_PUSH || m_dwKeyState[key] == KEY_HOLD)
//		{
...
//}
//
//bool XInput::Frame() { return true; }
//bool XInput::Render() { return true; }
//bool XInput::Release() { return true; }
//
//XInput::XInput()
//{
//}
